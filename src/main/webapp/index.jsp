			...
			<div class="row">
				<div class="col-md-12">
					<div class="latest-product">
						...
						<a href="ViewProductController?flag=1" class="view-details-link"><i
						...
						<a href="ViewProductController?flag=7" class="view-details-link"><i
							...
							href="ViewProductController?flag=5" class="view-details-link"><i
							class="fa fa-link"></i> 20,000-30,000</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
							href="ViewProductController?flag=6" class="view-details-link"><i
							class="fa fa-link"></i> 30,000-50,000</a>
						...
						<div class="product-carousel">
							...
							<div class="single-product">
								...
								<h2><%=productBean.getpName()%></h2>
								<h2><%=productBean.getpDetail()%></h2>
								<div class="product-carousel-price">
									<ins><%=productBean.getpPrice()%></ins>
									<ins><%=productBean.getpType()%></ins>
								</div>
							</div>
							<%
							}
